...
mass_groups <- list(
   groupA = c(1122.2045, 1196.951, 1282.375571, 1056.251706, 997.627),    # unmodified, CS 18-14+
   groupB = c(1127.202625, 1202.282333, 1288.087714, 1060.955824, 1002.069778),    # monophos, CS 18-14+ 
   groupC = c(1132.20075, 1207.613667, 1293.799857, 1065.659941, 1006.512556)    # diphos, CS 18-14+ 
)
...
plot <- ggplot(combined_data, aes(x = times, y = y_smooth_scaled, color = group)) +
   geom_line(size = 1) +
   labs(y = "Rel. Abundance", x = "Migration time (min)", color = "Cleaved, \u03B22AR Proteoform \n Charge states 14-18+") + # Change legend title here
...
ggsave(plot, filename = "C:/Users/ives435/OneDrive - PNNL/Desktop/GPCR paper/xie_b2arMD_trip.png",
